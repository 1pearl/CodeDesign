...
sequenceDiagram
    ...
    Note over Client,Originator: 阶段一：配置发布与持续归档

    Client->>Originator: 1. setConfigFile(v1 哈哈)
    Client->>Originator: 2. saveMemento()
    Originator-->>Client: 返回Memento(v1)
